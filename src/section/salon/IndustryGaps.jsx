    ...
    const gapPoints = [
        {
            ...
            title: "Generic Instagram Presence",
            desc: "You blend in with every other salon. No style, no voice, no standout factor.",
        },
        {
            icon: <ImageIcon size={30} className="text-[#03414e]" />,
            title: "Slow, Dated Websites",
            desc: "Clunky pages and broken links frustrate users before they even book.",
        },
        {
            icon: <Sparkles size={30} className="text-[#03414e]" />,
            title: "No Booking Experience",
            desc: "No online scheduling = missed appointments and manual headaches.",
        },
    ];
        ...
        <section className="relative w-full bg-gradient-to-b  to-white py-20 px-6 sm:px-16">
            <div className="max-w-5xl mx-auto ">
                ...
                <p className="text-[#03414e] text-base sm:text-lg leading-relaxed mt-20 mx-auto">
                    Most salon marketing feels generic and outdated—missing the polish needed to turn scrollers into bookings.
                </p>
            </div>
        </section>
    );
